	...
	<section class="mx-5">
            <div class="container mt-5 bg-light">
                <div class="card px-5 pt-5 pb-3">
                    <form action="<%= request.getContextPath() %>/board/boardUpdateCheck" method="POST">
                        <input type="hidden" name="id" value="<%= vo.getBoardId() %>">
                        <div class="card-body">
                            <div class="card-title">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="제목을입력하세요." value="<%= vo.getTitle() %>">
                                </div>
                            </div>
                            ...
                            <div class="input-group" style="height: 600px;">
                                <div class="input-group-prepend">
                                    <span class="input-group-text h-100">내용</span>
                                </div>
